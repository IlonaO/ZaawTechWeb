    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a class="active" href="php/cylinder.php">Cylinder <span class="sr-only">(current)</span></a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-sx-12">
            ...
            <div class="form-group">
                <label>Radius</label>
                <input type="number" class="form-control" id="cyl_radius" placeholder="Enter radius" min="1" max="1000"
                       required>
            </div>
            <div class="form-group">
                <label>Height</label>
                <input type="number" class="form-control" id="cyl_height" placeholder="Enter height" min="1" max="1000"
                       required>
            </div>
            <div class="form-group">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-sx-12">
            ...
            <form method="post" action="cylinder.php">
                <div class="form-group">
                    <label>Radius</label>
                    <input type="number" class="form-control" name="radius" placeholder="Enter radius" min="1"
                           max="1000" required>
                </div>
                <div class="form-group">
                    <label>Height</label>
                    <input type="number" class="form-control" name="height" placeholder="Enter height" min="1"
                           max="1000" required>
                </div>
                <div class="form-group">
